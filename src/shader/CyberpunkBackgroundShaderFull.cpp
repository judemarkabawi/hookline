...
"\n"
"\n"
"void render_layer(out vec4 color, out float alpha, in float dist, in vec2 uv, in vec2 cameraPos, in float MAX_FOG_DIST, in int layer) {\n"
"    vec2 uv0 = uv;\n"
...
"    switch(layer) { \n"
"       case 0: \n"
"           emission = u_bg_emission;\n"
"           color = u_bg_color;\n"
"           normal = u_bg_normal;\n"
"           break;\n"
"       case 1: \n"
"           emission = u_mg_emission;\n"
"           color = u_mg_color;\n"
"           normal = u_mg_normal;\n"
"           break;\n"
"       case 0: \n"
"           emission = u_fg_emission;\n"
"           color = u_fg_color;\n"
"           normal = u_fg_normal;\n"
"           break;\n"
"} \n"
"    vec4 _mat_ = texture(emission, _uv_);\n"
"    vec3 mat = _mat_.xyz;\n"
"    alpha = _mat_.w;\n"
"    vec3 albedo = texture(color, _uv_).xyz;\n"
"    vec4 _norm_and_ambient_ = texture(normal, _uv_);\n"
...
"    \n"
"    //vec4 cyan_emission = hex_shader(gl_FragCoord.xy, u_drawable_size.xy, u_time, norm, 75.0);\n"
...
"    vec3 fog = env_pallette(fog_factor)*vec3(0.7) + vec3(0.2, 0.2, 0.1);\n"
"    float fog_amt = 0.9;\n"
"    \n"
"    col += emission;\n"
"    \n"
...
"    float alpha = 0.0;\n"
"    //bg\n"
"    render_layer(color, alpha, 120.0, uv, cameraPos, MAX_FOG_DIST, 0);\n"
"    fragColor = vec4(vec3(color.xyz), 1.0);\n"
"    \n"
"    //mg\n"
"    render_layer(color, alpha, 80.0, uv + 0.5*u_drawable_size.xy/minR, cameraPos, MAX_FOG_DIST, 1);\n"
"    if(alpha > 0.0) fragColor = mix(fragColor, vec4(vec3(color.xyz), 1.0), alpha);\n"
"    \n"
"    //fg\n"
"    render_layer(color, alpha, 30.0, uv + 0.5*u_drawable_size.xy/minR, cameraPos, MAX_FOG_DIST, 2);\n"
"    if(alpha > 0.0) fragColor = mix(fragColor, vec4(vec3(color.xyz), 1.0), alpha);\n"
"\n"
"}\n");
    ...
    glUniform1i(m.u_bg_color, 0);
    glUniform1i(m.u_bg_normal, 0);
    glUniform1i(m.u_mg_emission, 0); 
    glUniform1i(m.u_mg_color, 0);
    glUniform1i(m.u_mg_normal, 0);
    glUniform1i(m.u_fg_emission, 0); 
    glUniform1i(m.u_fg_color, 0);
    glUniform1i(m.u_fg_normal, 0);
    glUniform1i(m.u_bg_cube, 0);
